 ...
 *
 */
public class HiloFitness1 extends Thread {
	...
	/**************************** CONSTRUCTOR ******************************/
	public HiloFitness1(NGramas ngramas, Texto claseTexto, HashMap<Character, Character> claveDescifrado, Semaphore sem, Fitness numFitness) {
	...
	public void calculaFitness() {
		...
		this.fitness = 0;
		int j = 0;
		for (int i = 0; i < this.claseTexto.puntoMedio + 6; i++) {
